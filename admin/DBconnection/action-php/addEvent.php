<?php
	...
	if($ACTION == 'ADDEVENT'){
		...
		$SQL = "INSERT INTO event (event_name, owner_name, place, budget, date_start, date_end, time_start, time_end, detaill, soundName, staff, manageName, type_event_ID, status) VALUES ('$NAME_EVENT', '$OWNER_NAME', '$PLACE', '$BUDGET', '$DATE_START', '$DATE_END', '$TIME_START', '$TIME_END', '$DETAIL', '$SOUNDNAME', '$STAFF', '$MANAGENAME', $TYPE_EVENT_ID,'$STATUS')";
echo "<pre><br>$SQL<br>";
